 ...
 * @return A [VerificationError] if validation fails, or null if valid.
 *
 * @see W3CCredentialJwtV1
 * @see VerificationError
 * @see VerificationContext
 */
internal val issClaimMatchesEitherMetadataOrCredentialIssuerVerifier: Verifier<W3CCredentialJwtV1> =
    { credential, context ->
