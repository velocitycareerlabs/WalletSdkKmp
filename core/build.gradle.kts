...
kotlin {
    ...
    androidLibrary {
        namespace = "io.velocitycareerlabs.core"
        compileSdk = 36
        minSdk = 24
...
//                implementation(libs.waltid.digital.credentials)
//                implementation(libs.waltid.openid4vc)
//                implementation(libs.waltid.did)
//                implementation(libs.waltid.sdjwt)
//                implementation(libs.waltid.verification.policies)
//                implementation(libs.waltid.openid4vc)
//                implementation(libs.waltid.dif.definitions.parser)
            }
        }
